...
class AdminAccountTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->encryptorMock->expects($this->any())->method('getHash')->will($this->returnValue('hash'));
        ...
        $this->adminAccount = new AdminAccount($this->setUpMock, $this->encryptorMock, $data);
    }
